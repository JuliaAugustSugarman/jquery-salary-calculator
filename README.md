...
STEPS:
BUILD OUT HTML TABLE, INPUT COLUMN NAMES
MAKE INPUT VESSELS
MAKE SUBMIT BUTTON


NEXT STEPS:
GET BUTTON TO FUNCTION
AND GET THE INPUT VESSELS TO ACCEPT INFO
GET INFO TO GO INTO LIST
clear fields
make it variablle to add fields div and span
jq and append div to monthly costs
